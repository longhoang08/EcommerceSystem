...
from ecommerce_server.extensions.custom_exception import WrongPasswordException
from ecommerce_server.helpers.faker import fake_user
from ecommerce_server.tests.api import APITestCase
